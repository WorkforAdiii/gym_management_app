...
useEffect(()=>{
  ...
  return (
    <div className="w-1/4 h-[100vh] bg-slate-950 backdrop-blur-lg border border-white/20 text-white p-6 shadow-xl">
      ...
      <div className="mt-10 py-8 border-t-2 border-gray-700 space-y-4">
        ...
        <div className="flex items-center gap-5 font-semibold mt-8 text-white text-lg px-4 py-3 rounded-xl 
                  bg-white/10 backdrop-blur-md border border-white/10 
                  shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] 
                  hover:bg-red-500/20 hover:text-black-
                  hover:shadow-[0_0_10px_rgba(255,0,0,0.3)] 
                  transition duration-300 cursor-pointer hover:bg-red hover:text-white">
